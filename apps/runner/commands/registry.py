...
perf_app = typer.Typer(help="Measure and tune local runtime performance.")
jobs_app = typer.Typer(help="Durable background-job operations.")
evolve_app = typer.Typer(help="Governed local self-evolution operations.")
rollout_app = typer.Typer(help="Shadow, canary, promotion, and rollback operations.")

...
|---|---:|---|---|
| github | 1183 | GitHub OpenAPI official | build • cli • mcp • tests |
| stripe | 587 | Stripe OpenAPI official | build • cli • mcp • tests |
| sentry | 209 | Sentry OpenAPI official | build • cli • mcp • tests |
...
Plus 17+ recipe templates in `library/recipes/` for common sources (Hacker News, CoinGecko, PokeAPI, Open-Meteo, REST Countries, Nominatim, npm registry, PyPI, exchange rates, public holidays, Reddit, Spotify, Slack, Xquik, …).
...
- ✅ 21 catalog entries shipped, 17+ recipe templates

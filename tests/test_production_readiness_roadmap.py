...
def test_release_zip_rejects_models_credentials_and_generated_data(tmp_path: Path) -> None:
    ...
    for member in (
        ...
        "data/april.db-wal",
        "data/april.db-shm",
        "data/april.write.lock",
        ".env",
        ".env.production",
        ".pytest_cache/v/cache/nodeids",
        "APRIL/data/jobs/job.json",
        "APRIL/data/evolution/candidate.json",
        "APRIL/data/vector_index/CURRENT",
        "APRIL/data/model-import/candidate.gguf.sha256",
